...
import 'package:latihanbabempat/screens/detail_screen.dart';
  ...
  final List<Map<String, String>> news = [
    {
      ...
      'author': 'Wahyu',
      'description':
          'Cukup salin salah satu URL di atas dan gunakan sebagai imageURL di aplikasi Flutter atau HTML <img> tag. Kamu juga bisa mengunduh gambar dari URL tersebut dan menyimpannya untuk digunakan secara offine.',
      'time': '4h ago',
    },
    {
      'imageUrl':
            ...
            children: [
              Text(
                ...
                Text(
                  ...
                  style:
                  TextStyle(
                  color: Color(0xFF1877F2), fontSize: 24,fontWeight: FontWeight.bold )
                )
            ],
          ),
